    ...
    <header>
        <nav>
            <ul class="nav-bar">
                ...
                <li class="nav-button"><a href="/public/overview/articleoverview.html"><i class="fa-solid fa-lightbulb"></i><br>Articles</a></li>
                <li class="nav-button"><a href="/public/overview/storyoverview.html"><i class="fa-solid fa-heart"></i><br>Stories</a></li>
