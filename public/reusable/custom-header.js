    ...
    <header>
        <nav>
            <ul class="nav-bar">
                ...
                <li id="login-button" class="pro-login"><a href="/public/volunteers/chat/chat.html"><i class="fa-solid fa-user"></i><br><p>Here as a professional?<br>Login to chat</p></a></li>
            </ul>
        </nav> 
    </header>
`;
